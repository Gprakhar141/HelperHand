...
import { Flex, Text, Box, FormControl, Input, FormLabel, Button, useDisclosure, ModalHeader } from "@chakra-ui/react";
...
const Actions = ({ post }) => {
  ...
  const handleLikeAndUnlike = async() => {
    ...
    try {
      ...
      if(!liked) {
        ...
        //remove(filter) the id of the current user to the post.likes array
  ...
  const handleReply = async () => {
    if(!user) showToast("Error","You must be logged in to reply to a post","error")
    ...
    <Flex flexDirection="column">
      ...
      >
        ...
        <ModalHeader/>
          ...
          <ModalBody pb={6}>
            <FormControl>
              <Input ref={initialRef} placeholder='Reply goes here...' 
